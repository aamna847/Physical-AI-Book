...
const config = {
  ...
  url: 'https://physical-ai-book.vercel.app', // Replace with your site's URL
  ...
  organizationName: 'aamna847', // Usually your GitHub org/user name.
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl:
            'https://github.com/aamna847/Physical-AI-Book/tree/main/',
        },
        blog: {
    ...
    ({
      ...
      navbar: {
        ...
        items: [
          ...
          {
            href: 'https://github.com/aamna847/Physical-AI-Book',
            label: 'GitHub',
            position: 'right',
          },
        ],
